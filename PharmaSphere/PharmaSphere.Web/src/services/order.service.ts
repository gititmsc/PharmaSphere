...
function toRequest(v: OrderFormValues) {
  ...
  return {
    ...
    label:                           n(v.label),
    monoBox:                         n(v.monoBox),
    monthBox:                        n(v.monthBox),
    tray:                            n(v.tray),
    leaflet:                         n(v.leaflet),
    syringeAndNeedle:                n(v.syringeAndNeedle),
    shrink:                          n(v.shrink),
    shipper:                         n(v.shipper),
    hologram:                        n(v.hologram),
    ...
    ppNotApplicable: v.ppNotApplicable,
    ppApplyDate:    d(v.ppApplyDate),
    ppDraftDate:    d(v.ppDraftDate),
    ppApprovalDate: d(v.ppApprovalDate),
    ppReceivedDate: d(v.ppReceivedDate),
    cppNotApplicable: v.cppNotApplicable,
    cppApplyDate:    d(v.cppApplyDate),
    cppDraftDate:    d(v.cppDraftDate),
    cppApprovalDate: d(v.cppApprovalDate),
    cppReceivedDate: d(v.cppReceivedDate),
    coppNotApplicable: v.coppNotApplicable,
    coppApplyDate:    d(v.coppApplyDate),
    coppDraftDate:    d(v.coppDraftDate),
    coppApprovalDate: d(v.coppApprovalDate),
    coppReceivedDate: d(v.coppReceivedDate),
    fscNotApplicable: v.fscNotApplicable,
    fscApplyDate:    d(v.fscApplyDate),
    fscDraftDate:    d(v.fscDraftDate),
    fscApprovalDate: d(v.fscApprovalDate),
    fscReceivedDate: d(v.fscReceivedDate),
    ...
    productionMonoBox:               d(v.productionMonoBox),
    productionLabel:                 d(v.productionLabel),
    productionInsert:                d(v.productionInsert),
    productionTray:                  d(v.productionTray),
    productionShipper:               d(v.productionShipper),
